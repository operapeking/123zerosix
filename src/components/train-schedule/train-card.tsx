...
import { Train as TrainIcon, Clock, Building2, ChevronDown, ChevronUp, ChevronRight } from 'lucide-react';
...
export function TrainCard({ train, selectedClass, onSelectClass }: TrainCardProps) {
  ...
  const { hours: duration } = calculateTimeDifference(train.departure.time, train.arrival.time);
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex-1 text-center">
            <div className="space-y-1">
              ...
              <div className="flex items-center justify-center gap-2 text-muted-foreground">
                ...
                <TimeDisplay time={train.departure.time} />
              </div>
            </div>
          </div>

          <div className="flex flex-col items-center mx-4">
            <ChevronRight className="h-6 w-5 text-muted-foreground" />
          ...
          <div className="flex-1 text-center">
            <div className="space-y-1">
              ...
              <div className="flex items-center justify-center gap-2 text-muted-foreground">
                <Clock className="h-4 w-4" />
                <TimeDisplay time={train.arrival.time} />
              </div>
            </div>
          </div>
        </div>
